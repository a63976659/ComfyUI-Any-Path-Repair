export function injectCSS() {
    ...
    styleElem.textContent = `
        ...
        .fixer-notice-top { font-size: 18px; font-weight: bold; color: #00e676; text-align: center; margin-bottom: 15px; padding-bottom: 15px; border-bottom: 1px dashed #444; letter-spacing: 1px; }
        .fixer-dialog h3 { margin-top: 0; border-bottom: 1px solid #444; padding-bottom: 10px; display: flex; align-items: center; justify-content: space-between; flex-shrink: 0; }
        .fixer-dialog-content { overflow-y: auto; flex-grow: 1; margin: 10px 0; padding-right: 8px; min-height: 100px; max-height: 60vh; scrollbar-width: thin; scrollbar-color: #555 #2b2b2b; }
        ...
        .fixer-copy-btn { display: inline-block; margin-top: 8px; margin-left: 8px; background: #444; color: white; padding: 6px 12px; border: 1px solid #666; border-radius: 4px; font-size: 12px; cursor: pointer; vertical-align: middle; transition: all 0.2s; }
        ...
        .fixer-dialog-footer { display: flex; justify-content: flex-end; gap: 10px; margin-top: 15px; border-top: 1px solid #333; padding-top: 15px; flex-shrink: 0; }
